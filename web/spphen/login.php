...
<body class="hold-transition login-page">
  <div class="login-box">
    <!--<div class="login-logo">
      <a href="#"><b>Aplikasi Pembayaran SPP</b></a>
    </div>-->
    <!-- /.login-logo -->
    <div class="card">
      <div class="card-body login-card-body">
        <p class="login-box-msg">Halaman Login Untuk Admin dan Petugas</p>
        <hr>
        <?php 
        if(isset($_GET['info'])){
          if($_GET['info'] == "gagal"){ ?>
          ...
          <form action="cek_login_petugas.php" method="post">
            ...
            <div class="row">
              ...
              <div class="col-12">
                <hr>
                <a href="index.php" class="btn btn-block bg-gradient-warning btn-lg">Halaman Login Siswa</a>
              </div>
              <!-- /.col -->
            </div>
          </form>
